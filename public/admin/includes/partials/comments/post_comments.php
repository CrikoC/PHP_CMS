...
<form action="" method="post">
    ...
    <table class="table table-responsive table-hover">
        ...
        <?php
        $post_id = $_GET['post'];
        $comments = Comment::find_by_post_admin($post_id);
            ...
            <tr>
                ...
                <td>
                    <?php if($comment->status == 'dismissed' || $comment->status == 'pending') { ?>
                        <a href="comments.php?post=<?php echo $post_id; ?>&approve=<?php echo $comment->id; ?>">Approve</a>
                    <?php  } else { ?>
                    <a href="comments.php?post=<?php echo $post_id; ?>&dismiss=<?php echo $comment->id; ?>">Dismiss</a></td>
                <?php } ?>
                <td>
                    <button
                        type="button"
